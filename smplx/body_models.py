...
def build_layer(
    ...
    model_type: str = 'smpl',
    **kwargs
) -> Union[SMPLLayer, SMPLHLayer, SMPLXLayer, SMILLayer,MANOLayer, FLAMELayer]:
    ...
    elif model_type.lower() == 'smil':
        return SMILLayer(model_path,**kwargs)
...
def create(
    ...
    model_type: str = 'smpl',
    **kwargs
) -> Union[SMPL, SMPLH, SMPLX, SMIL, MANO, FLAME]:
    ''' Method for creating a model from a path and a model type
